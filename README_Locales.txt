...
PDS oPos supports 15 languages.

English UK is the default language set.

Not all locales are completely translated

The locale files shipped with this version of PDS oPos are the latest at the date of this release.
...
You will find the files in the PDS oPos installation folder in the
...
3. Set the PDS oPos Configuration>Locale to your required language